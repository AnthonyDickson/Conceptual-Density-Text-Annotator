...
INSERT INTO `document_section` (`id`, `document_id`, `section_number`, `title`, `text`)
VALUES (1, 1, 1, 'introduction',
...
INSERT INTO `section_annotation` (`id`, `document_id`, `section_id`, `start`, `end`, `tag`)
VALUES (59, 1, 1, 5, 6, 'A PRIORI'),
       (60, 1, 1, 48, 49, 'EMERGING'),
       (61, 1, 1, 88, 97, 'RELATION'),
       (62, 1, 1, 185, 186, 'A PRIORI'),
       (63, 1, 2, 13, 14, 'FORWARD'),
       (64, 1, 2, 128, 129, 'BACKWARD'),
       (65, 1, 2, 46, 47, 'ENTITY');
